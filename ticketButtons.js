...
module.exports = async function ticketButtons(interaction, client) {
  ...
  if (customId === 'ticket_close') {
    ...
    if (!isMod && !isOwner) {
      return interaction.reply({ content: '❌ Only the ticket owner or moderators can close this ticket.', ephemeral: true });
    }
